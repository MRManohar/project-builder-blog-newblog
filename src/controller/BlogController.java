...
public class BlogController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String blogTitle = offensive(blogData[0]);
		String blogDescription = offensive(blogData[1]);
	...
	private static String offensive(String string){
		String [] offensiveWords = new String[]{"abbo"
				, "abo"
				, "abortion"
				, "abuse"
				, "addict"
		...
		for(int i=0;i<stringArr.length;i++){
			for(int j=0;j<offensiveWords.length;j++){
				if(stringArr[i].equals(offensiveWords[j])){
					stringArr[i]="#";
					count++;
				}
			}
		...
		stringArr = removeHash(stringArr,count);
	...
	private static String[] removeHash(String[] stringArr,int c) {
		int j=0;
		String[] stringData = new String[stringArr.length-c];
		for(int i=0;i<stringArr.length;i++){
			if(!(stringArr[i].equals("#")))
				stringData[j++]=stringArr[i];
		}
		return stringData;
	}
}
